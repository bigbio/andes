...
Benchmarked at 1% FDR across three reference datasets. **Read the metric note below the table before quoting these numbers** — an audit on 2026-09-04 found the entrapment description that used to sit here overstated what two of the three columns measure ([`docs/benchmarks/`](docs/benchmarks/README.md)):

...
fn workspace_root() -> PathBuf {
    // CARGO_MANIFEST_DIR points at crates/msgf-rust at test compile time.
...
fn precursor_cal_off_pin_tsv_match_golden_after_sort() {
    ...
    let binary = PathBuf::from(env!("CARGO_BIN_EXE_msgf-rust"));
    ...
    assert!(status.success(), "msgf-rust exited {status}");

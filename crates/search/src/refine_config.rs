...
//! tier (5 mods, the classic hyperscore engine always-on chemistry) is used when no config is given.
...
impl RefineConfig {
    /// The built-in DEFAULT tier: the the classic hyperscore engine always-on chemistry. Used when

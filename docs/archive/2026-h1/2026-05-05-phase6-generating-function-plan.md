...
```bash
cd /Users/user/work/msgfplus-workspace/astral-speed/rust && \
...
```bash
git -C /Users/user/work/msgfplus-workspace/astral-speed add \
  rust/crates/engine/src/gf/score_dist.rs
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "feat(engine): ScoreDist::add_prob_dist + add_num_dist (Phase 6/Task 3)"
```
...
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "feat(engine): ScoredSpectrum::{node_score,edge_score} + RankScorer extensions (Phase 6/Task 4)"
```
...
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "feat(engine): PrimitiveAaGraph CSR amino-acid graph (Phase 6/Task 5)"
```
...
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "feat(engine): graph-based GeneratingFunction::compute (Phase 6/Task 6)"
```
...
```bash
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "feat(engine): GeneratingFunctionGroup multi-bin merger (Phase 6/Task 7)"
```
...
```bash
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "feat(engine): wire SpecEValue into PsmMatch + match_engine (Phase 6/Task 8)"
```
...
```bash
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "test(engine): SpecEValue Java parity on 5 traced PSMs (Phase 6/Task 9)"
```
...
```bash
git -C /Users/user/work/msgfplus-workspace/astral-speed commit -m "test(engine): BSA SpecEValue parity gate ≥95% within 1 OOM (Phase 6/Task 10)"
```

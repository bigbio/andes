...
**a comparison search engine 0.14.7**, **a comparison engine 2025.01** (via OpenMS), and **ProSE** (OpenMS), across
...
| a comparison search engine 0.14.7 | 32,091 / 21,398 | 11,232 / 9,481 | 15,653 / 4,202 |
...
(≈10–40×), on par with the C++/Rust engines (a comparison engine/a comparison search engine 1–4 min). andes is the

...
**Canonical public benchmark — andes vs Java MS-GF+ vs Comet:**

| Benchmark | Date | Engines | Datasets |
|---|---|---|---|
| [Public benchmark](2026-06-15-public-benchmark.md) | 2026-06-15 | andes (top-1 + `--chimeric`), Java MS-GF+, Comet | Astral (HCD high-res), TMT a05058 (CID low-res), UPS1/PXD001819 (CID low-res) |
...
Early multi-engine validation runs (include MSFragger / Sage / ProSE for development

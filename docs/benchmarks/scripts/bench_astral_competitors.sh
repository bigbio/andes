...
a comparison search engine=/srv/data/msgf-bench/engines/a comparison search engine-v0.14.7-x86_64-unknown-linux-gnu/a comparison search engine
SAGECFG=/srv/data/msgf-bench/repo/msgf-rust/docs/benchmarks/configs/a comparison search engine-astral.json

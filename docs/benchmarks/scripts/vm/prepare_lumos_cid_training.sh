...
OUT_DIR="${OUT_DIR:-/data/msnet/flat}"
WORK="${WORK:-/data/msgf-bench/lumos-train-work}"
BASE="${BASE:-/data/msgf-bench/tmt-data}"
...
FLAT_PY="${FLAT_PY:-/data/msgf-bench/mzml_pepxml_to_flat.py}"

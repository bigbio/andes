...
**2026-06-04** — Make Andes's scoring an **independent implementation** of the published
...
For Andes's purpose (not a verbatim derivative) that is the practical standard.

...
Andes-native models trained from **public** data. This removes the final derivation →
...
Train Andes-native models with the fixed estimator; write a fresh `models.parquet` with
